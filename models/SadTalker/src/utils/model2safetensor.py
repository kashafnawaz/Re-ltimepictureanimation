...
audio2pose_checkpoint = os.path.join(current_root_path, 'checkpoints', 'audio2pose_00140-model.pth')
audio2pose_yaml_path = os.path.join(current_root_path, 'src', 'config', 'audio2pose.yaml')
